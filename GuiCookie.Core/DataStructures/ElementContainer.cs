...
namespace GuiCookie.Core.DataStructures
{
    public struct ElementEnumerator : IEnumerator<Element>, IEnumerator<ElementContainer>
    {
        ...
        public readonly Element Current => !mainDone ? mainEnumerator.Current?.Element : additionEnumerator.Current?.Element;

        readonly object IEnumerator.Current => !mainDone ? mainEnumerator.Current : additionEnumerator.Current;

        readonly ElementContainer IEnumerator<ElementContainer>.Current => !mainDone ? mainEnumerator.Current : additionEnumerator.Current;
    ...
    public class ElementContainer(Element element) : IEnumerable<Element>
    {
        ...
        /// </summary>
        private readonly List<ElementContainer> additionQueue = [];
        #endregion
        ...
        private readonly Signal<Element> onChildAdded = new();
