...
{
    public readonly struct Sides(float top, float right, float bottom, float left, SideMask relativeSides)
    {
        #region Relative Properties
        public readonly bool IsTopRelative => (relativeSides & SideMask.Top) == SideMask.Top;

        public readonly bool IsRightRelative => (relativeSides & SideMask.Right) == SideMask.Right;

        public readonly bool IsBottomRelative => (relativeSides & SideMask.Bottom) == SideMask.Bottom;

        public readonly bool IsLeftRelative => (relativeSides & SideMask.Left) == SideMask.Left;
        #endregion
        ...
        {
            Rectangle inverseScaledRectangle = new()
            {
