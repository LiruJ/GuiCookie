...
namespace GuiCookie.Core.DataStructures
{
    ...
    public readonly struct Space
    {
        ...
        public static Space Empty => new(0, Axes.None);
        #endregion
        ...
        public Vector2 GetScaledSpace(Vector2 parentSpace) => new(GetScaledX(parentSpace.X), GetScaledY(parentSpace.Y));

        public Point GetScaledSpace(Point parentSpace) => new((int)Math.Floor(GetScaledX(parentSpace.X)), (int)Math.Floor(GetScaledY(parentSpace.Y)));
        #endregion
