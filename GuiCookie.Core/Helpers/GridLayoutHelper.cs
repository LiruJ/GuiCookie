...
namespace GuiCookie.Core.Helpers
{
    ...
    public static class GridLayoutHelper
    {
        ...
        /// <param name="cellSize"> The size of a cell. </param>
        /// <returns> The snapped pixel position. </returns>
        public static Point CellToPixelPosition(Vector2 cellPosition, Point cellSize) => CellToPixelPosition(VectorExtensions.Floor(cellPosition).ToPoint(), cellSize);
        ...
        /// <param name="cellSize"> The size of a cell. </param>
        /// <returns> The snapped pixel position. </returns>
        public static Point CellToPixelPosition(Point cellPosition, Point cellSize) => PointExtensions.Multiply(cellPosition, cellSize);
        ...
        public static Space CellToPixelSpace(Point cellPosition, Point cellSize, Point? spacing = null) => new(CellToPixelPosition(cellPosition, PointExtensions.Add(cellSize, spacing ?? new Point())));
        ...
        public static Point PixelToCellPosition(Point pixelPosition, Point cellSize) => VectorExtensions.Floor(pixelPosition.ToVector2() / cellSize.ToVector2()).ToPoint();
        ...
        public static Point AdjustSize(Point sizeInCells, Point cellSize) => PointExtensions.Multiply(sizeInCells, cellSize);
